...
export default function IntroPanel() {
  ...
  const sectionTiming = useMemo(() => {
    ...
    // Tagline starts after role + company + linkedin fade in
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
          ...
          <motion.span
            ...
            animate={{ opacity: 1 }}
            transition={{
              delay: sectionTiming.role.start + sectionTiming.role.duration + 0.1,
              duration: 0.2
            }}
          >
            ·
          ...
          <motion.a
            ...
            animate={{ opacity: 1 }}
            transition={{
              delay: sectionTiming.role.start + sectionTiming.role.duration + 0.15,
              duration: 0.3
            }}
          >
            <svg
