...
interface MobileMultilingualSheetProps {
  isOpen: boolean;
  onClose: () => void;
  currentIndex: number;
...
const notes = multilingualContent.designDetails;

export function MobileMultilingualSheet({
  isOpen,
  onClose,
  currentIndex,
  onIndexChange,
}: MobileMultilingualSheetProps) {
