  ...
  return (
    <div className="min-h-screen p-8 pb-20 sm:p-20">
      <main className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          <h2 className="text-h2 mb-6 text-primary">Concept development and testing</h2>
          <p className="text-body text-secondary mb-6 leading-relaxed">
          ...
          <h3 className="text-h3 mb-4 text-primary">Interview insights</h3>
          ...
          <h3 className="text-h3 mb-4 text-primary">Design refinements</h3>
          <p className="text-body text-secondary mb-6 leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-h2 mb-6 text-primary">Key insights from testing</h2>
          <div className="space-y-6">
            <div className="border-l-4 border-green-500 pl-6">
              <h3 className="text-body mb-3 text-primary">Direct homepage access</h3>
              <p className="text-secondary">
            ...
            <div className="border-l-4 border-green-500 pl-6">
              <h3 className="text-body mb-3 text-primary">Contextual actions</h3>
              <p className="text-secondary">
            ...
            <div className="border-l-4 border-blue-500 pl-6">
              <h3 className="text-body mb-3 text-primary">Homepage as a guide</h3>
              <p className="text-secondary">
            ...
            <div className="border-l-4 border-purple-500 pl-6">
              <h3 className="text-body mb-3 text-primary">Goal management prompts</h3>
              <p className="text-secondary">
        ...
        <section className="mb-12">
          <h2 className="text-h2 mb-6 text-primary">Going from concept to execution</h2>
          <p className="text-body text-secondary mb-6 leading-relaxed">
          ...
          <div className="bg-surface p-6 rounded-lg mb-8">
            <h3 className="text-body mb-4 text-primary">Three key implementation slices</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-white dark:bg-gray-700 rounded-lg">
                <div className="text-h2 text-blue-600 dark:text-blue-400 mb-2">Slice 1</div>
                <p className="text-caption text-tertiary">Foundation</p>
              </div>
              <div className="text-center p-4 bg-white dark:bg-gray-700 rounded-lg">
                <div className="text-h2 text-blue-600 dark:text-blue-400 mb-2">Slice 2</div>
                <p className="text-caption text-tertiary">Enhancement</p>
              </div>
              <div className="text-center p-4 bg-white dark:bg-gray-700 rounded-lg">
                <div className="text-h2 text-blue-600 dark:text-blue-400 mb-2">Slice 3</div>
                <p className="text-caption text-tertiary">Full concept</p>
              </div>
            </div>
          </div>

          <h3 className="text-h3 mb-4 text-primary">Customer testing & technical conversations</h3>
          <p className="text-body text-secondary mb-6 leading-relaxed">
          ...
          <div className="bg-success/20 p-6 rounded-lg">
            <h4 className="text-body mb-3 text-primary">Final customer validation</h4>
            <blockquote className="text-secondary italic border-l-2 border-green-500 pl-4">
