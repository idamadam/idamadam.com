    ...
    <div className="min-h-screen p-8 pb-20 sm:p-20">
      <main className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="bg-surface p-6 rounded-lg mb-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-caption">
              <div>
                <strong className="text-primary">My Role:</strong> Lead Product Designer
              </div>
              <div>
                <strong className="text-primary">Timeline:</strong> [Duration] - [Time period]
              </div>
              <div>
                <strong className="text-primary">Team:</strong> 2 supporting designers, Product Manager, Engineering, Data Science, People Science team
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-blue-500 pl-6">
              <h3 className="text-h3 font-semibold mb-3 text-primary">1. Review Quality Problem</h3>
            ...
            <div className="border-l-4 border-blue-500 pl-6">
              <h3 className="text-h3 font-semibold mb-3 text-primary">2. Data Collation Problem</h3>
              <p className="text-secondary">
        ...
        <section className="mb-12">
          ...
          <h3 className="text-h3 font-semibold mb-4 text-primary">What I learnt from managers about their review process</h3>
          <p className="text-secondary mb-4">Through interviews and process observation, I discovered:</p>
          
          <div className="space-y-4">
            <div className="bg-surface p-4 rounded-lg">
              <h4 className="font-semibold text-primary mb-2">Cognitive overhead is massive</h4>
              <p className="text-secondary">
            ...
            <div className="bg-surface p-4 rounded-lg">
              <h4 className="font-semibold text-primary mb-2">Validation behavior, not creation</h4>
              <p className="text-secondary">
            ...
            <div className="bg-surface p-4 rounded-lg">
              <h4 className="font-semibold text-primary mb-2">Time sink frustration</h4>
              <p className="text-secondary">
            ...
            <div className="bg-surface p-4 rounded-lg">
              <h4 className="font-semibold text-primary mb-2">Quality awareness gap</h4>
              <p className="text-secondary">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <h3 className="text-h3 font-semibold mb-4 text-primary">Suggested Improvements (Phase 1)</h3>
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <h3 className="text-h3 font-semibold mb-4 text-primary">Highlights & Opportunities (Phase 2)</h3>
              <ul className="space-y-3 text-secondary">
          ...
          <div className="bg-surface p-6 rounded-lg">
            <h3 className="text-h3 font-semibold mb-4 text-primary">Broader organizational impact</h3>
        ...
        <section className="mb-12">
          <h2 className="text-h2 mb-6 text-primary">Reflection & Evolution</h2>
          <p className="text-body text-secondary mb-6 leading-relaxed">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-green-500 pl-6">
              <h3 className="text-h3 font-semibold mb-3 text-primary">Early AI adoption lessons</h3>
              <p className="text-secondary">
            ...
            <div className="border-l-4 border-green-500 pl-6">
              <h3 className="text-h3 font-semibold mb-3 text-primary">AI UX maturity</h3>
              <p className="text-secondary">
            ...
            <div className="border-l-4 border-green-500 pl-6">
              <h3 className="text-h3 font-semibold mb-3 text-primary">Design system thinking</h3>
              <p className="text-secondary">
